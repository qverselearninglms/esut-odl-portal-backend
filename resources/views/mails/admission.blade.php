...
<body style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#fafafa;border-radius:10px" role="presentation">
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    <h3 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;font-size:28px;font-style:normal;font-weight:bold;color:#2D3142">Hello,&nbsp; {{ $student['name'] }}</h3>
    ...
    <p>Congratulations! We are pleased to inform you that you have been admitted to the Faculty: {{ $student['faculty'] }} and Department: {{  $student['department']  }} at {{ $student['school_name'] }} for the {{ $student['academic_year'] }} academic year.</p>

    <p>Your hard work and dedication have paid off, and we are excited to welcome you to our community of scholars. As a new member of our student body, you will be joining a supportive and dynamic environment where you can thrive and achieve your best.</p>

    <strong>Next Steps:</strong>
    <ol>
        <li><strong>Confirm Your Acceptance:</strong> Please confirm your acceptance of this offer by {{ $student['deadline_date'] }} by visiting our admissions portal <a href="{{ $student['portal_link'] }}">here</a>.</li>
        <li><strong>Visit Us:</strong> Consider visiting our campus to meet future classmates and professors and get a feel for the campus atmosphere.</li>
        <li><strong>Prepare Your Documents:</strong> Ensure that all necessary paperwork, including transcripts and enrollment forms, is submitted by the required deadlines.</li>
    </ol>

    <p>We look forward to helping you begin your journey and are here to assist you with any questions you may have. Please contact our admissions office at {{ $student['contact_info'] }} should you need any help.</p>

    <p>Welcome to {{ $student['school_name'] }}!</p>

    <p>Warm regards,</p>
    <p>{{ $student['sender_name'] }}</p>
    <p>{{ $student['sender_position'] }}</p>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">Thanks,<br><br>Unizik School</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
