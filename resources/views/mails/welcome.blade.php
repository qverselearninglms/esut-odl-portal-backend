                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                        Welcome and thank you for joining Unizik School!
                                                                        Your application has been successfully created
                                                                        and is almost ready. <br><br>

                                                                        Here are your login details:<br><br>
                                                                    <ul>
                                                                        <li>Reference: {{ $user->reference }}</li>
                                                                        <li>Password: {{ $password }}</li>
                                                                    </ul> <br><br>
                                                                    Please follow the button below to login and complete
                                                                    ...
                                                                    <span class="msohide es-button-border"
                                                                        style="border-style:solid;border-color:#2CB543;background:#7630f3;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all"><a
                                                                            href="{{ $url }}" class="es-button msohide"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:22px;padding:15px 20px 15px 20px;display:block;background:#7630f3;border-radius:30px;font-family:Imprima, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:26px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid  #7630f3;mso-hide:all;padding-left:5px;padding-right:5px">Login</a></span>
                                                                    <br><br>
                                                                    For security purposes, the above link will expire in
                                                                    24 hours. We recommend resetting your password as
                                                                    soon as possible. If the link expires before you are
                                                                    able to reset your password, please contact our
                                                                    support team at support@stghcs.com or use the
                                                                    'Forgot Password' option on the login page.<br><br>

                                                                    If you have any questions or need assistance, feel
                                                                    free to reach out to our support team.<br><br>

                                                                    Thank you for choosing St. Genevive Health Care
                                                                    Services! We’re thrilled to have you with us.
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                        Warm regards,<br><br>St. Genevive Health Care
                                                                        Services</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        © 2023&nbsp;St. Genevive Health Care Services
                                                                        Ltd<a target="_blank" href="#"
